...
function toNoticiasCards(items) {
  return items.map(function (item) {
    return {
      articleClass: 'bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col relative group cursor-pointer news-card',
